...
import AIReviewEvidence, { type Evidence } from './AIReviewEvidence.vue'
import AppIcon from '../../shared/ui/AppIcon.vue'
import AIReviewCoverage, { type ReviewCoverage } from './AIReviewCoverage.vue'
type Issue = Evidence & { file_path: string; line: number; severity: string; basis?: string; title: string; evidence: string; suggestion: string }
